...
def main(working_path):
    # working_path = "..\\datasets\\data_science_bowl_2017\\processed_LUNA_full\\subset0\\"
    file_list=glob(os.path.join(working_path, "images_*.npy"))
...
def create_parser():
    ...
    """
    parser = argparse.ArgumentParser(description='Make lung segmentation')
    parser.add_argument('--working_path', type=str, default='D:\\code\\datasets\\data_science_bowl_2017\\processed_LUNA_full\\subset0')
    return parser
